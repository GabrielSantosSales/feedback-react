      ...
      <div className="h-svh bg-very-dark-blue text-white flex justify-center items-center px-6 font-overpass">
        {submited === false ? (
          ...
          <div className="text-medium-grey font-bold flex justify-between mb-6">
            <input type="button" value={1} className="bg-darkblue w-10.5 h-10.5 rounded-full text-sm focus:bg-medium-grey focus:text-white" onClick={() => handleChangeRateNote(1)}/>
            <input type="button" value={2} className="bg-darkblue w-10.5 h-10.5 rounded-full text-sm focus:bg-medium-grey focus:text-white" onClick={() => handleChangeRateNote(2)}/>
            <input type="button" value={3} className="bg-darkblue w-10.5 h-10.5 rounded-full text-sm focus:bg-medium-grey focus:text-white" onClick={() => handleChangeRateNote(3)}/>
            <input type="button" value={4} className="bg-darkblue w-10.5 h-10.5 rounded-full text-sm focus:bg-medium-grey focus:text-white" onClick={() => handleChangeRateNote(4)}/>
            <input type="button" value={5} className="bg-darkblue w-10.5 h-10.5 rounded-full text-sm focus:bg-medium-grey focus:text-white" onClick={() => handleChangeRateNote(5)}/>
          </div>
